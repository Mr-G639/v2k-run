...
import { useAtomValue } from "jotai"; // <-- Thêm import này
import { userPointsState } from "@/state"; // <-- Thêm import này

export default function Points() {
  const points = useAtomValue(userPointsState); // <-- Lấy điểm từ state
  ...
  return (
    ...
    >
      <div className="text-xl font-medium opacity-95">{points} điểm</div> {/* <-- Hiển thị điểm thực tế */}
